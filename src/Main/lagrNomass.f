...
*     Write on diagnostics of RLAGRN
 ...
 41         FORMAT (3X,D12.4,' RLAGRMLP:',1P,19(1X,D9.2))
            WRITE (6,43) TTOT, (NPARTN(K),K=1,NLENS),NCORE
 43         FORMAT (3X,D12.4,' NPARTMLP:',19I10)
            WRITE (6,45) TTOT, (SIGR2(K),K=1,NLENS),SIGR2C
 45         FORMAT (3X,E12.4,' SIGR2MLP:',1P,19(1X,E9.2))
            WRITE (6,46) TTOT, (SIGT2(K),K=1,NLENS),SIGT2C
 46         FORMAT (3X,E12.4,' SIGT2MLP:',1P,19(1X,E9.2))
            WRITE (6,47) TTOT, (VROT(K),K=1,NLENS),VROTC
 47         FORMAT (3X,E12.4,' VROTMLP: ',1P,19(1X,E9.2))
         END IF
      end if
*
*
